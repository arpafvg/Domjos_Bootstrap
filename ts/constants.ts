...
# cat=domjos_bootstrap/enable/a; type=boolean; label=Bread-Crumb: Enable the Bread-Crumb und the top-menu
domjos_bootstrap.enabled.bread_crumb = 0

# cat=domjos_bootstrap/enable/b; type=boolean; label=Language-Menu: Enable the Language-Menu on the side next to top-menu
domjos_bootstrap.enabled.menu_lang = 0

# cat=domjos_bootstrap/enable/c; type=boolean; label=Social-Menu: Enable the Social-Menu in the footer
domjos_bootstrap.enabled.menu_social = 0

# cat=domjos_bootstrap/enable/d; type=boolean; label=Bottom-Menu: Enable the Bottom-Menu in the footer
domjos_bootstrap.enabled.menu_bottom = 0

# cat=domjos_bootstrap/enable/e; type=boolean; label=Background-Slider: Enable the Background-Slider (Pictures are in the Page-Settings as resources defined)
domjos_bootstrap.enabled.slider = 0


# cat=domjos_bootstrap/enable/f; type=boolean; label=Background-Slider-Fade: Enable the Background-Slider Fade-effect
domjos_bootstrap.enabled.slider.fade = 0

# cat=domjos_bootstrap/enable/g; type=boolean; label=Spam-Protection: Enable the Spam-Protection of EMail-Addresses
domjos_bootstrap.enabled.email = 0

# cat=domjos_bootstrap/enable/h; type=boolean; label=RSS-Feed: Enable the RSS-Feed of the website
domjos_bootstrap.enabled.rss = 0

# cat=domjos_bootstrap/enable/i; type=boolean; label=Google-Analytics: Enable Google-Analytics
domjos_bootstrap.enabled.analytics = 0

# cat=domjos_bootstrap/enable/j; type=boolean; label=Search: Enable the Search-Form
domjos_bootstrap.enabled.search = 0

# cat=domjos_bootstrap/enable/k; type=boolean; label=Resource-Compression: Enable the compression and concatenation of css and js
domjos_bootstrap.enabled.compression = 0


# cat=domjos_bootstrap/cmenu/a; type=int; label=Menu-Bottom-PID: ID of the subfolder for the bottom-menu on the bottom
domjos_bootstrap.menu.menu_bottom = 0

# cat=domjos_bootstrap/cmenu/b; type=int; label=Menu-Social-PID: ID of the subfolder for the social-menu on the bottom
...
# cat=domjos_bootstrap/other/b; type=string; label=Google-Analytics-ID: The Google-Analytics-ID
...
# cat=domjos_bootstrap/other/d; type=int; label=Background-Slider-Time: Slide-Time (in ms)
