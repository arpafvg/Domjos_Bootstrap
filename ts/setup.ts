...
lib.menu_lang {
    ...
    1 {
        ...
        NO {
            linkWrap =<li>|</li>
            stdWrap.override = <img title="german" alt="german" src="{$domjos_bootstrap.other.url}fileadmin/template/img/de.png"> || <img title="english" alt="english" src="{$domjos_bootstrap.other.url}fileadmin/template/img/gb.png">
        }
...
page.includeJS.file1 = https://codeorigin.jquery.com/jquery.min.js
...
#page.includeJSFooter.file2 = https://cdnjs.cloudflare.com/ajax/libs/jquery.colorbox/1.6.4/jquery.colorbox.js
page.includeJSFooter.file3 = fileadmin/template/js/custom.js
